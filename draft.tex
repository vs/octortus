...
\include{arch_translator_components}
\include{arch_commits_to_revisions_mapping}
\include{arch_processing_subversion_commits}
\include{arch_processing_git_commits}
\include{arch_fixed_subersion_repository_layout}
\section{Translated Concepts II.}
\include{concepts_branches_and_tags}
\include{concepts_merge}
\include{concepts_copies_and_renames}
\include{concepts_special_properties_and_attributes}
\include{concepts_git_forks}
\include{concepts_other}
