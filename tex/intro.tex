...
Subversion history as a sequence of revisions (red circles), while second layer represents Git repository history % vs: red cycles are not revision, red cycles are some changes at corresponding revisions
...
by putting Git commits on top of the corresponding Subversion revisions, whenever such correspondence exists. % vs: Git commits on top of changes at Subversion repository at correposnding revisions, not just revisions
\\\\
...
modifications of the corresponding branches in Subversion repository enclosed in a single revision. A special % vs: Ok, here it is clarified regarding changes vs. revisions
