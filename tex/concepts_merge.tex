...
such a way that svn:mergeinfo includes all revisions made on one ore more branches, 
then that svn:mergeinfo modification is translated into a Git merge commit.
\\\\
Just like with translation of git merge commit into Subversion revision, 
translation in the opposite direction is performed in two steps:
\begin{itemize}
\item Git commit corresponding to Subversion revision being translated is created accordingly 
...
referenced be Subversion svn:mergeinfo property.
\end{itemize}
