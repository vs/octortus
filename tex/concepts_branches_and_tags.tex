...
is translated into creation, deletion or replacement of the correspoding Git reference object (Git tag or branch). 
\\\\
Depending on the absence or presence of the actual contents modification accompaning creation of the /branches/\emph{branch} 
...
For the purpose of this speicification, Subversion branch is a subdirectory in the top-level /branches directory of
Subversion repsitory. Name of that very subdirectory is a branch name. /trunk top-level directory is considered to be a branch named "master".
